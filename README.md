# TYPE HYPE — Playtest Builds

Public download repository for **TYPE HYPE**, a Guitar Hero-style typing rhythm game coming to Steam.
...
The installer is self-contained — WebView2 runtime is bundled, no internet required after download.

## Installation

1. Download the `.exe` from the latest release.
2. Double-click the installer.
3. **Windows SmartScreen may show "Windows protected your PC."** Click **More info → Run anyway**. This is normal for any unsigned indie installer; a code signing certificate is being acquired ahead of the Steam launch.
...
Report bugs, balance issues, or feature requests via [GitHub Issues](https://github.com/coreyalanschmidt-creator/type-hype-playtest/issues) on this repo, or send them directly to the developer.

## Not Open Source

This repository hosts **release builds only**. The game source code is not published here. TYPE HYPE is a commercial product coming to Steam.
